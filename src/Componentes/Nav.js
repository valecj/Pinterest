...
import { PinterestIMG } from '../logo.js';
    ...
    return (
      <nav>
        <div>
          ...
          <div className="Inicio" onClick={this.props.goHome}>
            <a>Start</a>
          </div>

          <div>
            <a className="Following">Today</a>
          </div>

          <div>
            <a className="Following">Following</a>
          </div>
          ...
          <div>
            <a className="Comment">
              <div className='user-avatar'>
                <img src='https://i.imgur.com/sLoVIYs.png' alt='avatar' />
              </div>
            </a>
          </div>
